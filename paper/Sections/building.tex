% Building
With these operators, we can define any function atomically. To build up to
...
basically linear regression but on steroids. 
...
eventually lead to any function reaching a minimum.